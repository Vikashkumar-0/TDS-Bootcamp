...
--- Before Day-2 ---
I already knew a few basic Linux commands like ls, cd, and pwd, but I did not clearly understand PATH, pipes, redirection, or environment variables.
---
...
--- After Day-2 ---
I learned how the shell works, how PATH helps the shell find commands, how to navigate the Linux filesystem efficiently, how to inspect files from the terminal, how pipes connect commands together, how redirection controls input and output, and how environment variables are used by programs and shells.
